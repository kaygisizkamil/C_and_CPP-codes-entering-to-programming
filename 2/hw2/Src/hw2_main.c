...
{
	int date_day = 27, date_month=2, date_year=2009, dayno;
	printf("\n--------------------------------------------------------------------------\n");
...
{
	int start_day = 29, start_month=2, start_year=2020;
	int end_day = 30, end_month=2, end_year=2021;
	int numdays;
	printf("\n--------------------------------------------------------------------------\n");
...
{
	double a = 1.2, b = 3.156, c = 2.0, alpha;
	printf("\n--------------------------------------------------------------------------\n");
...
void test_print_tabulated() {
	...
	printf("--------------------------------------------------------------------------\n");
	print_tabulated(1395, 1.1, -1, 2, 02.0, 2, 3, 9.999, -3, '-');
}
